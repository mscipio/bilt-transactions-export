...
description: Use before starting feature work - creates isolated workspace with git worktrees for safe parallel development
...
- Beginning subagent-driven development

**Benefits:**
- Isolated workspace (no branch pollution)
...
Check for worktree preference in project docs or configuration.
...
After completing work, use the `finishing-a-development-branch` skill to:
1. Verify tests pass
...
**Called by:**
- `brainstorming` (Phase 7) - REQUIRED immediately after design approval, BEFORE writing-plans
...
**Workflow Position:**
```
brainstorming (Phase 7: approval)
        ↓
